...
//     // set behavior
//     var behavior = Behavior._(_lastMatcher);
...
//     mock?._removeLastInvocation();
//     // set verifier
//     return Verifier._(mock, _lastMatcher);
//   } finally {
//     // clear to prevent memory leak
//     _lastMatcher = null;
//   }
...
//     // function
//     if (_thenFunctionEnabled && _thenFunction != null) {
...
//         return;
//       }
//       if (_matcher?.match(invocation) == false) {
//         return;
//       }
